...
Select Case Request("OK") 
       ...
       Case "升版"
            ...
            sql = sql & "ApprovePerson,ApproveDate,PublishPerson,PublishDate,"
            sql = sql & "'"&request.cookies("fmea.truename")&"','"& now() & "'"
...
elseif request("act") = "edit" then
	...
	response.write"<input name='FMEANo' class='notline' size='15' value ='"&rs_ed("FMEANo")&"'>"
	...
	response.write"<td><input name='ProjectName' class='notline' size='25' value ='"&rs_ed("ProjectName")&"'></td>"
        response.write"<td><input name='ItemName' class='notline' size='20' value ='"&rs_ed("ItemName")&"'></td>"
        response.write"<td><input name='Model' class='notline' size='15' value ='"&rs_ed("Model")&"'></td>"
        response.write"<td><input name='Author' class='notline' size='10' value ='"&rs_ed("Author")&"'></td>"
        response.write"<td><input name='BurdenDept' class='notline' size='20' value ='"&rs_ed("BurdenDept")&"'></td>"
	response.write"<td><input name='Onduty' class='notline' size='10' value ='"&rs_ed("Onduty")&"'></td>"
...
elseif request("act") = "verup" then
	...
	response.write"<td>"&rs_ed("Onduty")&"</td>"
        ...
        response.write"<td><input name='OK' value='升版' type='submit' class='smallInput'></td>" 
        response.write"</tr>"   
        call closeDB()
else
      call MainBody()
...
while not rs.eof and n<= rs.pagesize
	...
	response.write"<td>"&rs("Onduty")&"</td>"
        ...
        response.write"<td>&nbsp;<a href=Appr_Browse.asp?cat=2&ID="&rs("PjID")&">流程</a>&nbsp;"
        if request.cookies("fmea.power") = "0" then         
         response.write"&nbsp;<a href=Pj_Browse.asp?act=edit&ID="&rs("PjID")&">勘误</a>&nbsp;"
         response.write"&nbsp;<a href=Pj_Browse.asp?act=verup&ID="&rs("PjID")&">升版</a>&nbsp;"
         response.write"&nbsp;<a href=Pj_Browse.asp?act=del&ID="&rs("PjID")&">删除</a>"
        end if
	response.write"</td></tr>"
	rs.MoveNext
n=n+1
