...
Select Case Request("OK") 
       Case "查询" 	                
            select case Request("cata")
              case "模糊查询"
	          Response.Redirect "chgrecord_all.asp?Cat=0&Sc="&Request("Search")			   	
              case "按日期查询"
	          Response.Redirect "chgrecord_all.asp?Cat=1&Sc="&Request("Search")
          end select            
End Select
...
select case request("cat")
       case "" 
       sql="SELECT top 300 * FROM v_wdairy order by 日期 DESC"
       pgs =20
       case 0
       sql="SELECT  * FROM v_wdairy where 原作业者工号 like '%"&request("Sc")& _
           ...
           "%' ORDER BY 日期" 
       case 1
         sql="SELECT  * FROM v_wdairy where 日期 = '"&request("Sc")&"'"
end select
...
<b><font face="华文新魏" size="3" color="#CC6600">替位记录</font></b>
</td><td align='right'>
...
Response.Write "<a href=chgrecord_all.asp?page="&page+1&">下页<a>&nbsp;"
Response.Write "<a href=chgrecord_all.asp?page="&pagecount&">尾页<a>"

elseif page=pagecount and not page=1  then         '没有下一页，但是有上一页' 
Response.Write "<a href=chgrecord_all.asp?page=1>首页<a>&nbsp;&nbsp;"
Response.Write "<a href=chgrecord_all.asp?page="&page-1&">上页<a>&nbsp;&nbsp;下页&nbsp;尾页"
...
Response.Write "<a href=chgrecord_all.asp?page=1>首页<a>&nbsp;"
Response.Write "<a href=chgrecord_all.asp?page="&page-1&">上页<a>&nbsp;"
Response.Write "<a href=chgrecord_all.asp?page="&page+1&">下页<a>&nbsp;"
Response.Write "<a href=chgrecord_all.asp?page="&pagecount&">尾页<a>"
end if 
