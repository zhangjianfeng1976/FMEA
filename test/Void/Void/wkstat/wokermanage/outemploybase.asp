...
Select Case Request("OK") 
       Case "查询" 	                
            select case Request("cata")
              case "高级查询"
              case "模糊查询"
	    Response.Redirect "outemploybase.asp?Cat=0&Sc="&Request("Search")			   		
              case "编外人员"
                    Response.Redirect "outemploybase.asp?Cat=1&Sc="&Request("Search")
          end select            
     Case "输入"
...
select case request("cat")
       case "" 
       sql="SELECT * FROM  v_outemploybase"
       pgs =100
       case 0
       sql="SELECT * FROM v_outemploybase where cardid like '%"&request("Sc")& _
...
<body>
<form action="outemploybase.asp">
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#5A8BCE">
<tr>

<td height="20" align='left' bgcolor="#e6f7ff">
各部门：
<a href="outemploybase.asp?Cat=0&Sc=A4">机器1制造部</a>&nbsp;&nbsp;
<a href="outemploybase.asp?Cat=0&Sc=A5">机器2制造部</a>&nbsp;&nbsp;
<a href="outemploybase.asp?Cat=0&Sc=A6">机器3制造部</a>&nbsp;&nbsp;
</td>
<td align='right' bgcolor="#e6f7ff">
...
<td width="8%">离职日</td>
<td width="8%">状态</td>
<td width="8%" align="center">编外人员考勤</td> 
</tr>
...
Response.Write "<a href=outemploybase.asp?page="&page+1&">下页</a>&nbsp;"
Response.Write "<a href=outemploybase.asp?page="&pagecount&">尾页</a>"

elseif page=pagecount and not page=1  then         '没有下一页，但是有上一页' 
Response.Write "<a href=outemploybase.asp?page=1>首页<a>&nbsp;&nbsp;"
Response.Write "<a href=outemploybase.asp?page="&page-1&">上页</a>&nbsp;&nbsp;下页&nbsp;尾页"
...
Response.Write "<a href=outemploybase.asp?page=1>首页</a>&nbsp;"
Response.Write "<a href=outemploybase.asp?page="&page-1&">上页</a>&nbsp;"
Response.Write "<a href=outemploybase.asp?page="&page+1&">下页</a>&nbsp;"
Response.Write "<a href=outemploybase.asp?page="&pagecount&">尾页</a>"
end if 
