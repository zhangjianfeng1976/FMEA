...
<%
if  Request.cookies("fmea.username") = ""  then
...
<tr bgcolor="#E6F7FF"><td height="30" align="center" colspan="7"><b>机种承认流程列表</b></td></tr> 
...
while not rs.eof and n<= rs.pagesize
	...
	response.write"<td height =20><a href=..\ProcessMan\Process_Browse.asp?cat=2&PjID="&rs("PjID")&">" &rs("Pjkey")&"</a></td>"
